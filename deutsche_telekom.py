...
class DeutscheTelekom:
    ...
    def build():
        ...
        net.add_monitor('opm1', l_berlin_leipzig, s1_l_berlin_leipzig, amp1_l_berlin_leipzig)
        ...
        net.add_monitor('opm2', l_berlin_leipzig, s2_l_berlin_leipzig, amp2_l_berlin_leipzig)
        ...
        net.add_monitor('opm3', l_berlin_leipzig, s3_l_berlin_leipzig, amp3_l_berlin_leipzig)
