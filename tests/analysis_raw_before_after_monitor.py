...
power_mean_rmse_27_m14 = []
ase_mean_rmse_27_m14 = []
nli_mean_rmse_27_m14 = []

power_mean_rmse_54_m14 = []
ase_mean_rmse_54_m14 = []
nli_mean_rmse_54_m14 = []

power_mean_rmse_81_m14 = []
ase_mean_rmse_81_m14 = []
nli_mean_rmse_81_m14 = []
...
for monitor in monitors:
    ...
    while file_id <= 97:
        ...
        else:power_mean_rmse_27_m14.append(np.median(powers_27_rmse))
        ...
        if mon == 'no-m':
            ...
            power_mean_rmse_54_m14.append(np.median(powers_54_rmse))
        ...
        if mon == 'no-m':
            ...
            power_mean_rmse_81_m14.append(np.median(powers_81_rmse))
        ...
        if mon == 'no-m':
            ...
            ase_mean_rmse_27_m14.append(np.median(ases_27_rmse))
        ...
        if mon == 'no-m':
            ...
            ase_mean_rmse_54_m14.append(np.median(ases_54_rmse))
        ...
        if mon == 'no-m':
            ...
            ase_mean_rmse_81_m14.append(np.median(ases_81_rmse))
        ...
        if mon == 'no-m':
            ...
            nli_mean_rmse_27_m14.append(np.median(nlis_27_rmse))
        ...
        if mon == 'no-m':
            ...
            nli_mean_rmse_54_m14.append(np.median(nlis_54_rmse))
        ...
        if mon == 'no-m':
            ...
            nli_mean_rmse_81_m14.append(np.median(nlis_81_rmse))
...
plt.plot(x, power_mean_rmse_27, color='b', linewidth=ls, label='NO-M-30%')
plt.plot(x, power_mean_rmse_54, color='y', linewidth=ls, label='NO-M-60%')
plt.plot(x, power_mean_rmse_81, color='r', linewidth=ls, label='NO-M-90%')

plt.plot(x, power_mean_rmse_27_m14, linestyle='None', marker='s', markersize=ms,
         markerfacecolor='None', color='b', label='M-14-30%')
plt.plot(x, power_mean_rmse_54_m14, linestyle='None', marker='v', markersize=ms,
         markerfacecolor='None', color='y', label='M-14-60%')
plt.plot(x, power_mean_rmse_81_m14, linestyle='None', marker='D', markersize=ms,
         markerfacecolor='None', color='r', label='M-14-90%')
plt.legend(ncol=2)
plt.grid(True)
fig_name = '../monitoring_power_before_after.eps'
...
plt.ylabel("Mean RMSE (dB) of \nSDN-controller QoT-E model")
plt.xlabel("Index and location of OPM nodes")
plt.plot(x, ase_mean_rmse_27, color='b', linewidth=ls, label='NO-M-30%')
plt.plot(x, ase_mean_rmse_54, color='y', linewidth=ls, label='NO-M-60%')
plt.plot(x, ase_mean_rmse_81, color='r', linewidth=ls, label='NO-M-90%')

plt.plot(x, ase_mean_rmse_27_m14, linestyle='None', marker='s', markersize=ms,
         markerfacecolor='None', color='b', label='M-14-30%')
plt.plot(x, ase_mean_rmse_54_m14, linestyle='None', marker='v', markersize=ms,
         markerfacecolor='None', color='y', label='M-14-60%')
plt.plot(x, ase_mean_rmse_81_m14, linestyle='None', marker='D', markersize=ms,
         markerfacecolor='None', color='r', label='M-14-90%')
plt.legend(ncol=2)
plt.grid(True)
fig_name = '../monitoring_ase_before_after.eps'
plt.savefig(fig_name, format='eps')
plt.clf()
...
plt.ylabel("Mean RMSE (dB) of \nSDN-controller QoT-E model")
plt.xlabel("Index and location of OPM nodes")
plt.plot(x, nli_mean_rmse_27, color='b', linewidth=ls, label='NO-M-30%')
plt.plot(x, nli_mean_rmse_54, color='y', linewidth=ls, label='NO-M-60%')
plt.plot(x, nli_mean_rmse_81, color='r', linewidth=ls, label='NO-M-90%')

plt.plot(x, nli_mean_rmse_27_m14, linestyle='None', marker='s', markersize=ms,
         markerfacecolor='None', color='b', label='M-14-30%')
plt.plot(x, nli_mean_rmse_54_m14, linestyle='None', marker='v', markersize=ms,
         markerfacecolor='None', color='y', label='M-14-60%')
plt.plot(x, nli_mean_rmse_81_m14, linestyle='None', marker='D', markersize=ms,
         markerfacecolor='None', color='r', label='M-14-90%')
plt.legend(ncol=2)
plt.grid(True)
fig_name = '../monitoring_nli_before_after.eps'
plt.savefig(fig_name, format='eps')
plt.clf()
