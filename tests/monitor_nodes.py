...
def monitor_nodes():
    ...
    transceiver1 = ('t1', 0, 'C')
    transceiver2 = ('t2', 0, 'C')
    lt_1 = net.add_lt('lt_1', transceivers=[transceiver1], Modulation_Format='batman')
    lt_2 = net.add_lt('lt_2', transceivers=[transceiver2], Modulation_Format='batman')
    ...
    boost_amp_1 = net.add_amplifier("boost_amp", 'EDFA', target_gain=20.0, boost=True, monitor_mode='out')
