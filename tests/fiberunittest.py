...
Compare functional vs. mnoptical fiber models
...
from simfunctions import (
    ...
    roadmOutput, flatWDG,
    plotChannelPower, pwr, ase, nli, tpwr,
    dB, dBm, cm, m, wdg1 )
...
def singlespantest():
    ...
    s1, _drop = roadmOutput(
        mux={'add':s0, 'loss':9.0, 'levelto': None},
        boost={'gtarg':9.0, 'wdg':flatWDG})
    print('s1', s1)
    ...
    # Comparison
    plotChannelPower({
        'r1 output (fn)': tpwr(s1),
        'r1 output (mn)': tpwr(m1),
