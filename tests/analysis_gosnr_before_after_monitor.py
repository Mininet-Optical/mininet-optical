...
monitors = ['no-m-random', 'm14-random']
for monitor in monitors:
    ...
    while file_id <= 97:
        ...
        if mon == 'no-m-random':
            ...
            gosnr_mean_rmse_27_m14.append(np.median(gosnr_27_rmse))
        ...
        if mon == 'no-m-random':
            ...
            gosnr_mean_rmse_54_m14.append(np.median(gosnr_54_rmse))
        ...
        if mon == 'no-m-random':
            ...
            gosnr_mean_rmse_81_m14.append(np.median(gosnr_81_rmse))
...
plt.legend(ncol=2)
plt.grid(True)
fig_name = '../monitoring_metrics_before_after_random.eps'
