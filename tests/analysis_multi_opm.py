...
plt.plot(osnr_mean_rmse_27, linestyle='None', marker='s', markerfacecolor='None', color='b', label='30% ch-load')
# plt.plot(gosnr_mean_rmse_54, linestyle='None', marker='v', markerfacecolor='None', color='y')
plt.plot(osnr_mean_rmse_81, linestyle='None', marker='D', markerfacecolor='None', color='r', label='90% ch-load')
plt.legend()
