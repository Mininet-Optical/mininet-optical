...
def Topology3():
    ...
    line_terminals = [net.add_lt('lt_%s' % (i), transceivers=[transceivers[i]]) for i in range (0,6)]
    ...
    net.transmit(line_terminals[0], roadm, resources=resources, modulation_method='bpsk')
