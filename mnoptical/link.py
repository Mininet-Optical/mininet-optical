...
class Span(object):
    ...
    def srs_effect_model(self):
        ...
        """
        # Note: The computation is done in the frequency domain which returns a positive SRS tilt
    ...
    def Bigo_SRS_model(self):
        ...
        g_Aeff = 8.2e-17  # estimated Raman gain coefficient for a 50 km span
        ...
        for optical_signal in self.optical_signals:
            ...
            delta_p_linear = db_to_abs(delta_p)  # convert to linear
            print("delta_p_linear: ", delta_p_linear)
