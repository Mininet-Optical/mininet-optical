...
# Physical model
from mininet_optical.link import Link as PhyLink, Span as FiberSpan, SpanTuple
from mininet_optical.node import ( LineTerminal as PhyTerminal, Transceiver,
...
class OpticalNet( Mininet ):
    ...
    def setgainCmd( self, ampName, gain ):
        ...
        # Translated from mininet_optical.network.mock_amp_gain_adjust()
