...
from mininet_optical.dataplane import ( OpticalLink,
...
from mininet_optical.ofcdemo.demolib import OpticalCLI as CLI, cleanup
from mininet_optical.rest import RestServer
if 'netconf' in argv:
    from mininet_optical.ofcdemo.netconfserver import NetconfServer
from mininet_optical.examples.singleroadm import plotNet
