...
preamp_link_roadm1_ols2 = net.add_amplifier('preamp-edfa2', 'EDFA')
# Add a link between ROADM1 and OLS2
link_roadm1_ols2 = net.add_link(roadm1, ols2, preamp=preamp_link_roadm1_ols2)
# Create a fiber span
...
# Add a link between ROADM1 and OLS2
link_roadm1_ols3 = net.add_link(roadm1, ols2, preamp=preamp_link_roadm1_ols3)
# Create a fiber span
