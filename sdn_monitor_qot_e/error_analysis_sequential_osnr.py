...
# osnr_corr_log_9 = get_corrected_struct(9)
# osnr_corr_log_27 = get_corrected_struct(27)
# osnr_corr_log_81 = get_corrected_struct(81)
# osnr_corr = {9: osnr_corr_log_9,
#               27: osnr_corr_log_27,
#               81: osnr_corr_log_81}
...
for mk, opm_key in enumerate(monitor_keys):
    ...
    for filename in files:
        if filename.endswith(".json"):
            ...
            error = compute_errors(gosnr_opm, osnr_est)
            errors_tmp[load].append(error)

            # # get osnr from QoT-E corrected
            # osnr_corrected = osnr_corr[load][opm_key][load][test_id]
            # # Compute errors for OPM and QoT-E corrected
            # error_c = compute_errors(osnr_opm, osnr_corrected)
